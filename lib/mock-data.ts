...
export const notifications: Notification[] = [
  {
    ...
    summary: "سفارش #۱۲۳۴ در راه است",
    body: "سفارش شماره #۱۲۳۴ با موفقیت از انبار ارسال شد و در حال حاضر توسط پست پیشتاز در مسیر تحویل به شما قرار دارد. زمان تقریبی تحویل ۲ تا ۳ روز کاری می‌باشد. برای پیگیری مرسوله می‌توانید به بخش سفارش‌های من مراجعه کنید.",
    time: "۱۰ دقیقه پیش",
    date: "۱۴۰۵/۰۳/۲۰",
    read: false,
    type: "order",
  ...
  },
  {
    id: "2",
    icon: "🎁",
    title: "تخفیف ویژه فعال شد",
    summary: "۲۰٪ تخفیف روی محصولات انتخابی",
    body: "به مناسبت جشنواره تابستانه نیتو، ۲۰ درصد تخفیف ویژه روی تمامی محصولات دسته‌بندی لوازم جانبی موبایل فعال شده است. این تخفیف تا پایان هفته معتبر است. همین حالا از فرصت استفاده کنید!",
    time: "۲ ساعت پیش",
    date: "۱۴۰۵/۰۳/۲۰",
    read: false,
    type: "promo",
  ...
  },
  {
    ...
    summary: "سفارش #۱۲۱۸ با موفقیت تحویل شد",
    body: "سفارش شماره #۱۲۱۸ با موفقیت در تاریخ ۱۴۰۵/۰۳/۱۹ تحویل داده شد. اگر مشکلی با سفارش خود دارید، تا ۷ روز آینده امکان ثبت درخواست مرجوعی وجود دارد. از خرید شما متشکریم!",
    time: "دیروز",
    date: "۱۴۰۵/۰۳/۱۹",
    read: true,
    type: "order",
  ...
  },
  {
    ...
    summary: "هدفون سونی WH-1000XM5 دوباره موجود شد",
    body: "محصول «هدفون بی‌سیم سونی WH-1000XM5» که در لیست علاقه‌مندی‌های شما بود، دوباره موجود شده است. این محصول با تعداد محدود عرضه شده و ممکن است به زودی تمام شود.",
    time: "دیروز",
    date: "۱۴۰۵/۰۳/۱۹",
    read: true,
    type: "system",
  ...
  },
  {
    ...
    summary: "نظرتان درباره گوشی سامسونگ ثبت شد",
    body: "نظر شما درباره محصول «گوشی سامسونگ گلکسی A54» با موفقیت ثبت شد و پس از بررسی توسط تیم ما منتشر خواهد شد. از اینکه تجربه خرید خود را با دیگران به اشتراک گذاشتید متشکریم.",
    time: "۲ روز پیش",
    date: "۱۴۰۵/۰۳/۱۸",
    read: true,
    type: "system",
  },
  {
    id: "6",
    icon: "💰",
    title: "کد تخفیف اختصاصی شما",
    summary: "کد NYTO15 با ۱۵٪ تخفیف",
    body: "به پاس وفاداری شما به فروشگاه نیتو، یک کد تخفیف ۱۵ درصدی اختصاصی برای شما صادر شده است. کد تخفیف: NYTO15 — این کد تا تاریخ ۱۴۰۵/۰۳/۳۱ معتبر است و روی تمامی محصولات قابل استفاده می‌باشد.",
    time: "۳ روز پیش",
    date: "۱۴۰۵/۰۳/۱۷",
    read: true,
    type: "promo",
